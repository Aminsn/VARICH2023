# This module fits the VARICH model to the data.
# Model specification is in stan_files/VARICH.stan
...
mod <- cmdstan_model('stan_files/VARICH.stan')
...
saveRDS(out, 'fitted_objects/varich_fitted.rds')
