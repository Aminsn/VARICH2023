# Description: This script fits a VAR model to the data.
# Model specification is in stan_files/VAR.stan
...
mod <- cmdstan_model('stan_files/VAR.stan')
...
test = out$draws(c("beta1", "beta2", "beta3", "alpha", "phi"))
max(summary(test)$rhat) < 1.05
# ========  saving the fitted model ======== 
saveRDS(out, 'fitted_objects/var_fitted.rds')
